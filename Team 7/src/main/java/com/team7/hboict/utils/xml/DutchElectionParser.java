...
public class DutchElectionParser {
    ...
    private final CandidatesListTransformer candidatesListTransformer;
     ...
     * @param candidatesListTransformer    the transformer that will be called while processing the candidate lists files.
    ...
    public DutchElectionParser(DefinitionTransformer definitionTransformer,
                               CandidatesListTransformer candidatesListTransformer,
     ...
     * Welke xml bestanden
     *
     * De parser bepaald hier welke xml bestanden er worden ingelezen
     */
